// RoyalSlider plugin (c) http://dimsemenov.com
// jquery.royalslider v9.4.11
...
g[a._g+a._v1]=a.st.css3easeInOut,d.css(g))):(a._x1="left",a._w1="top");var n;l(window).on("resize"+a.ns,function(){n&&clearTimeout(n);n=setTimeout(function(){a.x()},50)});a.ev.trigger("rsAfterPropsSetup");a.updateSliderSize();a.st.keyboardNavEnabled&&a._b2();if(a.st.arrowsNavHideOnTouch&&(a.hasTouch||a.msTouch))a.st.arrowsNav=!1;a.st.arrowsNav&&(d=a._o1,l('<div class="rsArrow rsArrowLeft"><div class="rsArrowIcn"></div></div><div class="rsArrow rsArrowRight"><div class="rsArrowIcn"></div></div>').appendTo(d),
...
function a(){b.isLoaded=!0;b.isLoading=!1;e();j();d()}function e(){if(!b.isAppended){var a=k.st.visibleNearby,c=b.id-k._o;if(!f&&!b.appendOnLoaded&&k.st.fadeinLoadedSlide&&(0===c||(a||k._r2||k._l2)&&(-1===c||1===c)))a={visibility:"visible",opacity:0},a[k._g+"transition"]="opacity 400ms ease-in-out",b.content.css(a),setTimeout(function(){b.content.css("opacity",1)},16);b.content=l(l("<div/>").append(b.content.clone(!0)).html());b.holder.find(".rsPreloader").length?b.holder.append(b.content):b.holder.html(b.content);
b.isAppended=!0;b.isLoaded&&(k._q2(b),d());b.sizeReady||(b.sizeReady=!0,setTimeout(function(){k.ev.trigger("rsMaybeSizeReady",b)},100))}}function d(){b.loadedTriggered||(b.isLoaded=b.loadedTriggered=!0,b.holder.trigger("rsAfterContentSet"),k.ev.trigger("rsAfterContentSet",b))}function g(){k.st.usePreloader&&b.holder.html(k._q1.clone())}function j(){if(k.st.usePreloader){var a=b.holder.find(".rsPreloader");a.length&&a.remove()}}var k=this;b.isLoaded?e():f?!k._l&&b.images&&b.iW&&b.iH?c():(b.holder.isWaiting=
!0,g(),b.holder.slideId=-99):c()},_p2:function(b){this._p1.append(b.holder);b.appendOnLoaded=!1},_g2:function(b,f){var c=this,h,a="touchstart"===b.type;c.ev.trigger("rsDragStart");if(l(b.target).closest(".rsNoDrag",c._r1).length)return c.dragSuccess=!1,!0;!f&&c._r2&&(c._s2=!0,c._t2());c.dragSuccess=!1;if(c._l2)a&&(c._u2=!0);else{a&&(c._u2=!1);c._v2();if(a){var e=b.originalEvent.touches;if(e&&0<e.length)h=e[0],1<e.length&&(c._u2=!0);else return}else b.preventDefault(),h=b,c.msEnabled&&(h=h.originalEvent);
c._l2=!0;c._b.on(c._k1,function(a){c._w2(a,f)}).on(c._l1,function(a){c._x2(a,f)});c._y2="";c._z2=!1;c._a3=h.pageX;c._b3=h.pageY;c._c3=c._v=(!f?c._h:c._d3)?h.pageX:h.pageY;c._e3=0;c._f3=0;c._g3=!f?c._p:c._h3;c._i3=(new Date).getTime();if(a)c._e1.on(c._m1,function(a){c._x2(a,f)})}},_j3:function(b,f){if(this._k3){var c=this._l3,h=b.pageX-this._a3,a=b.pageY-this._b3,e=this._g3+h,d=this._g3+a,g=!f?this._h:this._d3,e=g?e:d,d=this._y2;this._z2=!0;this._a3=b.pageX;this._b3=b.pageY;"x"===d&&0!==h?this._e3=
0<h?1:-1:"y"===d&&0!==a&&(this._f3=0<a?1:-1);d=g?this._a3:this._b3;h=g?h:a;f?e>this._m3?e=this._g3+h*this._n1:e<this._n3&&(e=this._g3+h*this._n1):this._z||(0>=this.currSlideId&&0<d-this._c3&&(e=this._g3+h*this._n1),this.currSlideId>=this.numSlides-1&&0>d-this._c3&&(e=this._g3+h*this._n1));this._g3=e;200<c-this._i3&&(this._i3=c,this._v=d);f?this._p3(this._g3):this._l&&this._o3(this._g3)}},_w2:function(b,f){var c=this,h,a="touchmove"===b.type;if(a){if(c._q3)return;var e=b.originalEvent.touches;if(e){if(1<
e.length)return;h=e[0]}else return}else h=b,c.msEnabled&&(h=h.originalEvent);c._z2||(c._e&&(!f?c._p1:c._r3).css(c._g+c._u1,"0s"),function g(){c._l2&&(c._s3=requestAnimationFrame(g),c._t3&&c._j3(c._t3,f))}());if(c._k3)b.preventDefault(),c._l3=(new Date).getTime(),c._t3=h;else if(e=!f?c._h:c._d3,h=Math.abs(h.pageX-c._a3)-Math.abs(h.pageY-c._b3)-(e?-7:7),7<h){if(e)b.preventDefault(),c._y2="x";else if(a){c._u3();return}c._k3=!0}else if(-7>h){if(e){if(a){c._u3();return}}else b.preventDefault(),c._y2="y";
c._k3=!0}},_u3:function(){this._q3=!0;this._z2=this._l2=!1;this._x2()},_x2:function(b,f){function c(a){return 100>a?100:500<a?500:a}function h(b,d){if(a._l||f)g=(-a._u-a._d1)*a._w,j=Math.abs(a._p-g),a._c=j/d,b&&(a._c+=250),a._c=c(a._c),a._w3(g,!1)}var a=this,e,d,g,j;d="touchend"===b.type||"touchcancel"===b.type;a.ev.trigger("rsDragRelease");a._t3=null;a._l2=!1;a._q3=!1;a._k3=!1;a._l3=0;cancelAnimationFrame(a._s3);a._z2&&(f?a._p3(a._g3):a._l&&a._o3(a._g3));a._b.off(a._k1).off(a._l1);d&&a._e1.off(a._m1);
a._i1();if(!a._z2&&!a._u2&&f&&a._v3){var k=l(b.target).closest(".rsNavItem");k.length&&a.goTo(k.index())}else{e=!f?a._h:a._d3;if(!a._z2||"y"===a._y2&&e||"x"===a._y2&&!e)if(!f&&a._s2){a._s2=!1;if(a.st.navigateByClick){a._i2(a.msEnabled?b.originalEvent:b);a.dragSuccess=!0;return}a.dragSuccess=!0}else{a._s2=!1;a.dragSuccess=!1;return}else a.dragSuccess=!0;a._s2=!1;a._y2="";var n=a.st.minSlideOffset;d=d?b.originalEvent.changedTouches[0]:a.msEnabled?b.originalEvent:b;var m=e?d.pageX:d.pageY,p=a._c3;d=
a._v;var q=a.currSlideId,r=a.numSlides,u=e?a._e3:a._f3,t=a._z;Math.abs(m-p);e=m-d;d=(new Date).getTime()-a._i3;d=Math.abs(e)/d;if(0===u||1>=r)h(!0,d);else{if(!t&&!f)if(0>=q){if(0<u){h(!0,d);return}}else if(q>=r-1&&0>u){h(!0,d);return}if(f){g=a._h3;if(g>a._m3)g=a._m3;else if(g<a._n3)g=a._n3;else{n=d*d/0.006;k=-a._h3;m=a._x3-a._y3+a._h3;0<e&&n>k?(k+=a._y3/(15/(0.003*(n/d))),d=d*k/n,n=k):0>e&&n>m&&(m+=a._y3/(15/(0.003*(n/d))),d=d*m/n,n=m);k=Math.max(Math.round(d/0.003),50);g+=n*(0>e?-1:1);if(g>a._m3){a._z3(g,
k,!0,a._m3,200);return}if(g<a._n3){a._z3(g,k,!0,a._n3,200);return}}a._z3(g,k,!0)}else p+n<m?0>u?h(!1,d):a._m2("prev",c(Math.abs(a._p-(-a._u-a._d1+1)*a._w)/d),!1,!0,!0):p-n>m?0<u?h(!1,d):a._m2("next",c(Math.abs(a._p-(-a._u-a._d1-1)*a._w)/d),!1,!0,!0):h(!1,d)}}},_o3:function(b){b=this._p=b;this._e?this._p1.css(this._x1,this._y1+(this._h?b+this._z1+0:0+this._z1+b)+this._a2):this._p1.css(this._h?this._x1:this._w1,b)},updateSliderSize:function(b){var f,c;if(this.st.autoScaleSlider){var h=this.st.autoScaleSliderWidth,
a=this.st.autoScaleSliderHeight;this.st.autoScaleHeight?(f=this.slider.width(),f!=this.width&&(this.slider.css("height",f*(a/h)),f=this.slider.width()),c=this.slider.height()):(c=this.slider.height(),c!=this.height&&(this.slider.css("width",c*(h/a)),c=this.slider.height()),f=this.slider.width())}else f=this.slider.width(),c=this.slider.height();if(b||f!=this.width||c!=this.height){this.width=f;this.height=c;this._a4=f;this._b4=c;this.ev.trigger("rsBeforeSizeSet");this.ev.trigger("rsAfterSizePropSet");
this._e1.css({width:this._a4,height:this._b4});this._w=(this._h?this._a4:this._b4)+this.st.slidesSpacing;this._c4=this.st.imageScalePadding;for(f=0;f<this.slides.length;f++)b=this.slides[f],b.positionSet=!1,b&&(b.images&&b.isLoaded)&&(b.isRendered=!1,this._q2(b));if(this._d4)for(f=0;f<this._d4.length;f++)b=this._d4[f],b.holder.css(this._i,(b.id+this._d1)*this._w);this._n2();this._l&&(this._e&&this._p1.css(this._g+"transition-duration","0s"),this._o3((-this._u-this._d1)*this._w));this.ev.trigger("rsOnUpdateNav")}this._j2=
this._e1.offset();this._j2=this._j2[this._i]},appendSlide:function(b,f){var c=this._s(b);if(isNaN(f)||f>this.numSlides)f=this.numSlides;this.slides.splice(f,0,c);this.slidesJQ.splice(f,0,'<div style="'+(this._l?"position:absolute;":this._n)+'" class="rsSlide"></div>');f<this.currSlideId&&this.currSlideId++;this.ev.trigger("rsOnAppendSlide",[c,f]);this._f4(f);f===this.currSlideId&&this.ev.trigger("rsAfterSlideChange")},removeSlide:function(b){var f=this.slides[b];f&&(f.holder&&f.holder.remove(),b<
